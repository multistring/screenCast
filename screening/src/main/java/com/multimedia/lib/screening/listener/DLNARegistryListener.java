package com.multimedia.lib.screening.listener;
...
public abstract class DLNARegistryListener implements RegistryListener {
    ...
    private List<DeviceInfo> build(Collection<Device> deviceList) {
        ...
        for (Device device : deviceList) {
            ...
            if (deviceInfo.getDevice()!=null && deviceInfo.getDevice().getType()!=null &&
                    deviceInfo.getDevice().getType().getType() != null && deviceInfo.getDevice().getType().getType().equals("MediaRenderer")) {
