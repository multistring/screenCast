...
void print_options(const AVDictionary *opts, const char *tag, int level);

void update_header_options(const char *prefix, const char *value, AVDictionary **pm);

void update_header_options_int(const char *prefix, int64_t value, AVDictionary **pm);
