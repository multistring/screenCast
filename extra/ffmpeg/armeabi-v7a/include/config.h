...
#define FFMPEG_CONFIGURATION "--arch=arm --cpu=cortex-a8 --enable-neon --enable-thumb --enable-gpl --enable-libxvid --disable-gpl --disable-nonfree --enable-small --disable-debug --disable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-avfilter --disable-postproc --disable-filters --enable-filter=loudnorm --enable-filter=volume --enable-filter=volumedetect --disable-avresample --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vdpau --disable-videotoolbox --disable-encoders --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=ac3 --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=eac3 --enable-decoder=hevc --enable-decoder=vp9 --enable-decoder=opus --enable-decoder=vorbis --enable-decoder=mpeg4 --enable-decoder=mpeg2video --enable-decoder=flv --enable-decoder=pcm_s16le --disable-hwaccels --disable-muxers --enable-muxer=mp4 --disable-demuxers --enable-demuxer=aac --enable-demuxer=hls --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegts --enable-demuxer=flv --enable-demuxer=webm_dash_manifest --enable-demuxer=detached --enable-demuxer=matroska --enable-demuxer=asf --enable-demuxer=avi --enable-demuxer=m4v --enable-demuxer=mpegps --enable-demuxer=eac3 --enable-demuxer=ac3 --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=hevc --enable-parser=opus --enable-parser=mpeg4video --enable-parser=mpegvideo --enable-parser=mpegaudio --enable-parser=vorbis --disable-bsfs --enable-bsf=extract_extradata --enable-bsf=aac_adtstoasc --enable-bsf=h264_mp4toannexb --enable-bsf=hevc_mp4toannexb --disable-protocols --enable-protocol=async --enable-protocol=hls --enable-protocol=http --enable-protocol=file --enable-protocol=tcp --enable-protocol=crypto --enable-protocol=ijkmediadatasource --enable-protocol=ijkiocache --enable-protocol=ijkio --enable-protocol=pipe --enable-protocol=rtmp --disable-devices --disable-iconv --disable-audiotoolbox --disable-videotoolbox --disable-linux-perf --disable-bzlib --enable-demuxer=srt --enable-demuxer=ass --enable-decoder=ssa --enable-decoder=ass --enable-decoder=srt --enable-gpl --enable-libxvid --prefix=/Users/wangzhaoyang/Desktop/ijk/innoijk/ijkplayer/android/contrib/build/ffmpeg-armv7a/output --cross-prefix=arm-linux-androideabi- --enable-cross-compile --target-os=linux --enable-pic --enable-asm --enable-inline-asm --enable-optimizations --enable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -I/Users/wangzhaoyang/Desktop/ijk/innoijk/ijkplayer/android/contrib/extra/libxvid-armv7a/include -march=armv7-a -mcpu=cortex-a8 -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb' --extra-ldflags=' -L/Users/wangzhaoyang/Desktop/ijk/innoijk/ijkplayer/android/contrib/extra/libxvid-armv7a/lib -lm -lxvidcore -Wl,--fix-cortex-a8'"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/Users/wangzhaoyang/Desktop/ijk/innoijk/ijkplayer/android/contrib/build/ffmpeg-armv7a/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/wangzhaoyang/Desktop/ijk/innoijk/ijkplayer/android/contrib/build/ffmpeg-armv7a/output/share/ffmpeg"
...
#define CONFIG_DETACHED_DEMUXER 1
#define CONFIG_EXT_HLS_DEMUXER 0
...
#define CONFIG_IJKFILEHOOK_PROTOCOL 0
